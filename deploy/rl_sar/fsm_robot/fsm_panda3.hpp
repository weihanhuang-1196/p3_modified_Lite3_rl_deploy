...
public:
    ...
    std::string CheckChange() override
    {
        ...
        {
            if(!CheckCode(fsm_state->motor_state.status_word, RobotState<float>::MotorCode::CODE::CODE_0637)) return state_name_;
...
public:
    ...
    void Enter() override
    {
        ...
        catch (const std::exception& e)
        {
            ...
            rl.fsm.RequestStateChange("RLFSMStateGetDown");
        }
    }
