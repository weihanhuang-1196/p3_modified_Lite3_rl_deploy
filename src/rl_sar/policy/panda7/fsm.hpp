...
#ifndef PANDA7_FSM_HPP
#define PANDA7_FSM_HPP

#include "fsm_core.hpp"
#include "rl_sdk.hpp"

namespace panda7_fsm
{
...
class Panda7FSMFactory : public FSMFactory
{
public:
    Panda7FSMFactory(const std::string& initial) : initial_state_(initial) {}
    std::shared_ptr<FSMState> CreateState(void *context, const std::string &state_name) override
    {
        RL *rl = static_cast<RL *>(context);
        if (state_name == "RLFSMStatePassive")
            return std::make_shared<panda7_fsm::RLFSMStatePassive>(rl);
            ...
            return std::make_shared<panda7_fsm::RLFSMStateRL_Locomotion>(rl);
        return nullptr;
    }
...
REGISTER_FSM_FACTORY(Panda7FSMFactory, "RLFSMStatePassive")

#endif // PANDA7_FSM_HPP
